...
{
  /// <summary>The diagnostic id for <see cref="InheritFromObservableObjectInsteadOfUsingINotifyPropertyChangedAttributeWarning"/>.</summary>
  public const string InheritFromObservableObjectInsteadOfUsingINotifyPropertyChangedAttributeId = "MVVMTK0032";

  /// <summary>The diagnostic id for <see cref="InheritFromObservableObjectInsteadOfUsingObservableObjectAttributeWarning"/>.</summary>
  public const string InheritFromObservableObjectInsteadOfUsingObservableObjectAttributeId = "MVVMTK0033";

  /// <summary>The diagnostic id for <see cref="FieldReferenceForObservablePropertyFieldWarning"/>.</summary>
  public const string FieldReferenceForObservablePropertyFieldId = "MVVMTK0034";

  /// <summary>The diagnostic id for <see cref="AsyncVoidReturningRelayCommandMethod"/>.</summary>
  public const string AsyncVoidReturningRelayCommandMethodId = "MVVMTK0039";

  /// <summary>The diagnostic id for <see cref="UseObservablePropertyOnPartialProperty"/>.</summary>
  public const string UseObservablePropertyOnPartialPropertyId = "MVVMTK0042";

  /// <summary>The diagnostic id for <see cref="WinRTObservablePropertyOnFieldsIsNotAotCompatible"/>.</summary>
  public const string WinRTObservablePropertyOnFieldsIsNotAotCompatibleId = "MVVMTK0045";

  /// <summary>The diagnostic id for <see cref="UseObservablePropertyOnSemiAutoProperty"/>.</summary>
  ...
  ///   <para>Format: <c>"Cannot apply [INotifyPropertyChangedAttribute] to type {0}, as it already declares the INotifyPropertyChanged interface"</c>.</para>
  /// </summary>
